...
return array(
	...
	'components'=>array(
		...
		'urlManager'=>array(
			'urlFormat'=>'path',
			'rules'=>array(
				'assesor/admin/<param1>'=>'assesor/admin',
				'<controller:\w+>/<id:\d+>'=>'<controller>/view',
				'<controller:\w+>/<action:\w+>/<id:\d+>'=>'<controller>/<action>',
				'<controller:\w+>/<action:\w+>'=>'<controller>/<action>',
				'validasi/cek/<id:\w+>' => 'validasi/cek/',
		...
		'db'=>array(
			'connectionString' => 'mysql:host=localhost;dbname=pendaftaran',
			'emulatePrepare' => true,
			'username' => 'root',
			'password' => '',
			'charset' => 'utf8',
		...
		'dbakademik'=>array(
			'class'=>'CDbConnection',
			'connectionString' => 'mysql:host=localhost;dbname=akd',
			'emulatePrepare' => true,
			'username' => 'root',
			'password' => '',
			'charset' => 'utf8',
